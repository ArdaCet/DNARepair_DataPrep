...
RdD_1 <- read.csv("Zero_removed_divided_HDA64A1_ATCACG_normalized_allseqs_w_ChrStartEnd.csv", header = FALSE, 
                    sep=",",stringsAsFactors=FALSE, quote="\"", na.strings = "NA", fill=TRUE)
head(RdD_1)

# CPD Damage's XR-seq, Damage-seq and ChIP-seq Data:

RdD_2 <- read.csv("Zero_removed_divided_HDACA6_GCCAAT_normalized_allseqs_w_ChrStartEnd.csv", header = FALSE, 
                    sep=",",stringsAsFactors=FALSE, quote="\"", na.strings = "NA", fill=TRUE)
head(RdD_2)

# Selecting columns for data fame:

RdD_1_filtered = RdD_1 %>% select(V1:V20) %>% mutate(XR_HXA64A1_DMG = as.numeric(V4), H3K79me2_64PPA = as.numeric(V6), H3K4me3_64PPA = as.numeric(V7), 
                                                     H3K4me3_1_64PPA = as.numeric(V8), H3K4me3_2_64PPA = as.numeric(V9), H3K27ac_64PPA = as.numeric(V10), 
                                                     H4K20me1_64PPA = as.numeric(V11), H3K27me3_64PPA = as.numeric(V12), H3K27me3_1_64PPA = as.numeric(V13), 
                                                     H3K36me3_64PPA = as.numeric(V14), H3K36me3_1_64PPA = as.numeric(V15), H3K4me2_64PPA = as.numeric(V16), 
                                                     H3K9ac_64PPA = as.numeric(V17), H3K9me3_64PPA = as.numeric(V18), H2AFZ_64PPA = as.numeric(V19), 
                                                     H3K4me1_64PPA = as.numeric(V20)) %>% select(XR_HXA64A1_DMG, H3K79me2_64PPA, H3K4me3_64PPA, H3K4me3_1_64PPA, 
...
RdD_2_filtered = RdD_1 %>% select(V1:V20) %>% mutate(XR_HXA64B7_DMG = as.numeric(V5), H3K79me2_64PPB = as.numeric(V6), H3K4me3_64PPB = as.numeric(V7), 
                                                     H3K4me3_1_64PPB = as.numeric(V8), H3K4me3_2_64PPB = as.numeric(V9), H3K27ac_64PPB = as.numeric(V10), 
                                                     H4K20me1_64PPB = as.numeric(V11), H3K27me3_64PPB = as.numeric(V12), H3K27me3_1_64PPB = as.numeric(V13), 
                                                     H3K36me3_64PPB = as.numeric(V14), H3K36me3_1_64PPB = as.numeric(V15), H3K4me2_64PPB = as.numeric(V16), 
                                                     H3K9ac_64PPB = as.numeric(V17), H3K9me3_64PPB = as.numeric(V18), H2AFZ_64PPB = as.numeric(V19), 
                                                     H3K4me1_64PPB = as.numeric(V20)) %>% select(XR_HXA64B7_DMG, H3K79me2_64PPB, H3K4me3_64PPB, H3K4me3_1_64PPB, 
...
RdD_3_filtered = RdD_2 %>% select(V1:V20) %>% mutate (XR_HXACA4_DMG = as.numeric(V4), H3K79me2_CPDA = as.numeric(V6), H3K4me3_CPDA = as.numeric(V7), 
                                                      H3K4me3_1_CPDA = as.numeric(V8), H3K4me3_2_CPDA = as.numeric(V9), H3K27ac_CPDA = as.numeric(V10), 
                                                      H4K20me1_CPDA = as.numeric(V11), H3K27me3_CPDA = as.numeric(V12), H3K27me3_1_CPDA = as.numeric(V13), 
                                                      H3K36me3_CPDA = as.numeric(V14), H3K36me3_1_CPDA = as.numeric(V15), H3K4me2_CPDA = as.numeric(V16), 
                                                      H3K9ac_CPDA = as.numeric(V17), H3K9me3_CPDA = as.numeric(V18), H2AFZ_CPDA = as.numeric(V19), 
                                                      H3K4me1_CPDA = as.numeric(V20)) %>% select(XR_HXACA4_DMG, H3K79me2_CPDA, H3K4me3_CPDA, H3K4me3_1_CPDA, 
...
RdD_4_filtered = RdD_2 %>% select(V1:V20) %>% mutate(XR_HXACB10_DMG = as.numeric(V5), H3K79me2_CPDB = as.numeric(V6), H3K4me3_CPDB = as.numeric(V7), 
                                                     H3K4me3_1_CPDB = as.numeric(V8), H3K4me3_2_CPDB = as.numeric(V9), H3K27ac_CPDB = as.numeric(V10), 
                                                     H4K20me1_CPDB = as.numeric(V11), H3K27me3_CPDB = as.numeric(V12), H3K27me3_1_CPDB = as.numeric(V13), 
                                                     H3K36me3_CPDB = as.numeric(V14), H3K36me3_1_CPDB = as.numeric(V15), H3K4me2_CPDB = as.numeric(V16), 
                                                     H3K9ac_CPDB = as.numeric(V17), H3K9me3_CPDB = as.numeric(V18), H2AFZ_CPDB = as.numeric(V19), 
                                                     H3K4me1_CPDB = as.numeric(V20)) %>% select(XR_HXACB10_DMG, H3K79me2_CPDB, H3K4me3_CPDB, H3K4me3_1_CPDB, 
...
####################
setwd('C:/Users/Arda/Documents/TEZ/TEZ-PlotResults/Histone_x_RepA-Normalized-Repair-ScatterPlot/log-scaled-versions/HXA64A1')
...
############################################
setwd('C:/Users/Arda/Documents/TEZ/TEZ-PlotResults/Histone_x_RepA-Normalized-Repair-ScatterPlot/log-scaled-versions/HXA64B7')
...
############################################
setwd('C:/Users/Arda/Documents/TEZ/TEZ-PlotResults/Histone_x_RepA-Normalized-Repair-ScatterPlot/log-scaled-versions/HXACA4')
...
############################################
setwd('C:/Users/Arda/Documents/TEZ/TEZ-PlotResults/Histone_x_RepA-Normalized-Repair-ScatterPlot/log-scaled-versions/HXACB10')
