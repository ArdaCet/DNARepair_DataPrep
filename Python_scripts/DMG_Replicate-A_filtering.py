...
for indiv_lines2 in stock_file2:
    ...
    DMG_CPD_column = float(splitted_lines2[9])
...
total = 0
directory = 'C://Users//Arda//Documents//TEZ//TEZ-Data//HeLa-Cells//xr_damage_chip_DNase-seq_Data//ReplicateA_Filtered_Normalized_allseq-Data//'
with open(directory + 'Zero_removed_divided_HDA64A1_ATCACG_normalized_allseqs_w_ChrStartEnd.csv','w') as df:
